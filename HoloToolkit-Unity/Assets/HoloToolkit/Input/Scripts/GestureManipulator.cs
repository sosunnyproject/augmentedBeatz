...
namespace HoloToolkit.Unity
{
    ...
    public class GestureManipulator : MonoBehaviour
    {
        ...
        {
            Debug.Log("START");
            topPosition = new Vector3(initialObjectPosition.x,
                       initialObjectPosition.y + distance,
                       initialObjectPosition.z);

            bottomPosition = new Vector3(initialObjectPosition.x,
                       initialObjectPosition.y + distance,
                       initialObjectPosition.z);
        ...
        private void Update()
        {
            if (Manipulating)
            {
                ...
                //TODO: Get relative point on line => float relativePosition = Vector3.Lerp(bottomPosition, topPosition, )
